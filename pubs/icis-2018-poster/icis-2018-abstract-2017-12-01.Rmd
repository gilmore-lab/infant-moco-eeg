...
Why optic flow? Why important?
Prior research suggests infant brains respond more strongly to linear flow (gilmore et al. 2007) and to larger displacements/faster speeds (Hou et al 2009). Pattern across primate (Kiorpes & Movshon, 2004). Children show intermediate responses (Gilmore, Thomas, & Fesi, 2016). High density EEG study with infants.

2. Sentence or two describing sample, displays, measures, analysis.
3. Sentences describing results.
4. Sentence or two describing implications, next steps.
